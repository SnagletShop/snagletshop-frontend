...
try {
  ...
  window.__ssSmartRecoRerenderTimer = __ssSmartRecoRerenderTimer;
  window.__ssBasketRenderInProgress = __ssBasketRenderInProgress;
  window.__ssBasketNeedsRerender = __ssBasketNeedsRerender;
  window.__ssBasketRerenderQueued = __ssBasketRerenderQueued;
  window.__ssContributionCache = __ssContributionCache;
  window.__ssAddonPoolSortedCache = __ssAddonPoolSortedCache;
} catch {}
